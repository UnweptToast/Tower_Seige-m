...
function draw() {
  ...
  if((ball.body.position.x < 0 || ball.body.position.x > width * 2 || (ball.body.position.x > width && ball.body.position.y > height) || ball.body.position.y > height || ball.body.position.y < 0 /*|| ball.body.speed < 3*/) && shotCounter>0) {
